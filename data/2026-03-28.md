...
### [17] [Towards automatic smoke detector inspection: Recognition of the smoke detectors in industrial facilities and preparation for future drone integration](https://arxiv.org/abs/2603.24850)
...
### [18] [OptiSAR-Net++: A Large-Scale Benchmark and Transformer-Free Framework for Cross-Domain Remote Sensing Visual Grounding](https://arxiv.org/abs/2603.24876)
...
### [19] [SurgPhase: Time efficient pituitary tumor surgery phase recognition via an interactive web platform](https://arxiv.org/abs/2603.24897)
...
### [20] [Self-Supervised Learning for Knee Osteoarthritis: Diagnostic Limitations and Prognostic Value of Uncurated Hospital Data](https://arxiv.org/abs/2603.24903)
...
### [21] [ICTPolarReal: A Polarized Reflection and Material Dataset of Real World Objects](https://arxiv.org/abs/2603.24912)
...
### [22] [BiFM: Bidirectional Flow Matching for Few-Step Image Editing and Generation](https://arxiv.org/abs/2603.24942)
...
### [23] [InstanceAnimator: Multi-Instance Sketch Video Colorization](https://arxiv.org/abs/2603.25357)
...
### [24] [CLIP-RD: Relational Distillation for Efficient CLIP Knowledge Distillation](https://arxiv.org/abs/2603.25383)
...
### [25] [FSGNet: A Frequency-Aware and Semantic Guidance Network for Infrared Small Target Detection](https://arxiv.org/abs/2603.25389)
...
### [26] [PMT: Plain Mask Transformer for Image and Video Segmentation with Frozen Vision Encoders](https://arxiv.org/abs/2603.25398)
...
### [27] [HiSpatial: Taming Hierarchical 3D Spatial Understanding in Vision-Language Models](https://arxiv.org/abs/2603.25411)
...
### [28] [VideoWeaver: Multimodal Multi-View Video-to-Video Transfer for Embodied Agents](https://arxiv.org/abs/2603.25420)
...
### [29] [DC-Reg: Globally Optimal Point Cloud Registration via Tight Bounding with Difference of Convex Programming](https://arxiv.org/abs/2603.25442)
...
### [30] [CIAR: Interval-based Collaborative Decoding for Image Generation Acceleration](https://arxiv.org/abs/2603.25463)
...
### [31] [GridVAD: Open-Set Video Anomaly Detection via Spatial Reasoning over Stratified Frame Grids](https://arxiv.org/abs/2603.25467)
...
### [32] [AdaSFormer: Adaptive Serialized Transformers for Monocular Semantic Scene Completion from Indoor Environments](https://arxiv.org/abs/2603.25494)
...
### [33] [Knowledge-Guided Failure Prediction: Detecting When Object Detectors Miss Safety-Critical Objects](https://arxiv.org/abs/2603.25499)
...
### [34] [RealRestorer: Towards Generalizable Real-World Image Restoration with Large-Scale Image Editing Models](https://arxiv.org/abs/2603.25502)
...
### [35] [Beyond the Golden Data: Resolving the Motion-Vision Quality Dilemma via Timestep Selective Training](https://arxiv.org/abs/2603.25527)
...
### [36] [BFMD: A Full-Match Badminton Dense Dataset for Dense Shot Captioning](https://arxiv.org/abs/2603.25533)
...
### [37] [Insights on back marking for the automated identification of animals](https://arxiv.org/abs/2603.25535)
...
### [38] [PAWS: Perception of Articulation in the Wild at Scale from Egocentric Videos](https://arxiv.org/abs/2603.25539)
...
### [39] [Towards Comprehensive Real-Time Scene Understanding in Ophthalmic Surgery through Multimodal Image Fusion](https://arxiv.org/abs/2603.25555)
...
### [40] [GeoHeight-Bench: Towards Height-Aware Multimodal Reasoning in Remote Sensing](https://arxiv.org/abs/2603.25565)
...
### [41] [Hierarchy-Guided Multimodal Representation Learning for Taxonomic Inference](https://arxiv.org/abs/2603.25573)
...
### [42] [UNIC: Neural Garment Deformation Field for Real-time Clothed Character Animation](https://arxiv.org/abs/2603.25580)
...
### [43] [LanteRn: Latent Visual Structured Reasoning](https://arxiv.org/abs/2603.25629)
...
### [44] [Designing Any Imaging System from Natural Language: Agent-Constrained Composition over a Finite Primitive Basis](https://arxiv.org/abs/2603.25636)
*Chengshuai Yang*
...
### [45] [LEMMA: Laplacian pyramids for Efficient Marine SeMAntic Segmentation](https://arxiv.org/abs/2603.25689)
...
### [46] [Wan-Weaver: Interleaved Multi-modal Generation via Decoupled Training](https://arxiv.org/abs/2603.25706)
...
### [47] [TRACE: Object Motion Editing in Videos with First-Frame Trajectory Guidance](https://arxiv.org/abs/2603.25707)
...
### [48] [Seeing to Ground: Visual Attention for Hallucination-Resilient MDLLMs](https://arxiv.org/abs/2603.25711)
...
### [49] [No Hard Negatives Required: Concept Centric Learning Leads to Compositionality without Degrading Zero-shot Capabilities of Contrastive Models](https://arxiv.org/abs/2603.25722)
...
### [50] [AnyHand: A Large-Scale Synthetic Dataset for RGB(-D) Hand Pose Estimation](https://arxiv.org/abs/2603.25726)
...
### [51] [BizGenEval: A Systematic Benchmark for Commercial Visual Content Generation](https://arxiv.org/abs/2603.25732)
...
### [52] [SlotVTG: Object-Centric Adapter for Generalizable Video Temporal Grounding](https://arxiv.org/abs/2603.25733)
...
### [53] [Unleashing Guidance Without Classifiers for Human-Object Interaction Animation](https://arxiv.org/abs/2603.25734)
...
### [55] [PSDesigner: Automated Graphic Design with a Human-Like Creative Workflow](https://arxiv.org/abs/2603.25738)
...
### [56] [MegaFlow: Zero-Shot Large Displacement Optical Flow](https://arxiv.org/abs/2603.25739)
...
### [57] [MuRF: Unlocking the Multi-Scale Potential of Vision Foundation Models](https://arxiv.org/abs/2603.25744)
...
### [58] [Less Gaussians, Texture More: 4K Feed-Forward Textured Splatting](https://arxiv.org/abs/2603.25745)
...
### [59] [ShotStream: Streaming Multi-Shot Video Generation for Interactive Storytelling](https://arxiv.org/abs/2603.25746)
...
### [60] [LLM-Driven Reasoning for Constraint-Aware Feature Selection in Industrial Systems](https://arxiv.org/abs/2603.24979)
...
### [61] [Exons-Detect: Identifying and Amplifying Exonic Tokens via Hidden-State Discrepancy for Robust AI-Generated Text Detection](https://arxiv.org/abs/2603.24981)
...
### [62] [Approaches to Analysing Historical Newspapers Using LLMs](https://arxiv.org/abs/2603.25051)
...
### [63] [OMIND: Framework for Knowledge Grounded Finetuning and Multi-Turn Dialogue Benchmark for Mental Health LLMs](https://arxiv.org/abs/2603.25105)
...
### [64] [To Write or to Automate Linguistic Prompts, That Is the Question](https://arxiv.org/abs/2603.25169)
...
### [65] [Prompt Attack Detection with LLM-as-a-Judge and Mixture-of-Models](https://arxiv.org/abs/2603.25176)
...
### [66] [Cross-Preference Learning for Sentence-Level and Context-Aware Machine Translation](https://arxiv.org/abs/2603.25183)
...
### [67] [A Catalog of Basque Dialectal Resources: Online Collections and Standard-to-Dialectal Adaptations](https://arxiv.org/abs/2603.25189)
...
### [68] [SafeMath: Inference-time Safety improves Math Accuracy](https://arxiv.org/abs/2603.25201)
...
### [69] [Translation Asymmetry in LLMs as a Data Augmentation Factor: A Case Study for 6 Romansh Language Varieties](https://arxiv.org/abs/2603.25489)
...
### [70] [An Experimental Comparison of the Most Popular Approaches to Fake News Detection](https://arxiv.org/abs/2603.25501)
...
### [71] [Humans vs Vision-Language Models: A Unified Measure of Narrative Coherence](https://arxiv.org/abs/2603.25537)
...
### [72] [PICon: A Multi-Turn Interrogation Framework for Evaluating Persona Agent Consistency](https://arxiv.org/abs/2603.25620)
...
### [73] [Self-Improvement of Large Language Models: A Technical Overview and Future Outlook](https://arxiv.org/abs/2603.25681)
...
### [74] [S2D2: Fast Decoding for Diffusion LLMs via Training-Free Self-Speculation](https://arxiv.org/abs/2603.25702)
...
### [76] [On the Foundations of Trustworthy Artificial Intelligence](https://arxiv.org/abs/2603.24904)
*TJ Dunham*
...
### [77] [LogitScope: A Framework for Analyzing LLM Uncertainty Through Information Metrics](https://arxiv.org/abs/2603.24929)
...
### [78] [Decoding Market Emotions in Cryptocurrency Tweets via Predictive Statement Classification with Machine Learning and Transformers](https://arxiv.org/abs/2603.24933)
...
### [85] [Sparse Visual Thought Circuits in Vision-Language Models](https://arxiv.org/abs/2603.25075)
*Yunpeng Zhou*
...
### [86] [When Sensing Varies with Contexts: Context-as-Transform for Tactile Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2603.25115)
...
### [87] [RubricEval: A Rubric-Level Meta-Evaluation Benchmark for LLM Judges in Instruction Following](https://arxiv.org/abs/2603.25133)
...
### [88] [UniAI-GraphRAG: Synergizing Ontology-Guided Extraction, Multi-Dimensional Clustering, and Dual-Channel Fusion for Robust Multi-Hop Reasoning](https://arxiv.org/abs/2603.25152)
...
### [89] [The Competence Shadow: Theory and Bounds of AI Assistance in Safety Engineering](https://arxiv.org/abs/2603.25197)
*Umair Siddique*
...
### [90] [Does Structured Intent Representation Generalize? A Cross-Language, Cross-Model Empirical Study of 5W3H Prompting](https://arxiv.org/abs/2603.25379)
*Peng Gang*
...
### [91] [Retraining as Approximate Bayesian Inference](https://arxiv.org/abs/2603.25480)
*Harrison Katz*
