...
### [31] [CM-EVS: Sparse Panoramic RGB-D-Pose Data for Complete Scene Coverage](https://arxiv.org/abs/2605.15597)
...
### [32] [Pretraining Objective Matters in Extreme Low-Data FGVC: A Backbone-Controlled Study](https://arxiv.org/abs/2605.15599)
...
### [33] [Latent Video Prediction Learns Better World Models](https://arxiv.org/abs/2605.15618)
...
### [34] [LRCP: Low-Rank Compressibility Guided Visual Token Pruning for Efficient LVLMs](https://arxiv.org/abs/2605.15621)
...
### [35] [MaTe: Images Are All You Need for Material Transfer via Diffusion Transformer](https://arxiv.org/abs/2605.15660)
...
### [78] [Segmentation, Detection and Explanation: A Unified Framework for CT Appearance Reasoning](https://arxiv.org/abs/2605.15997)
...
### [79] [Echo-Forcing: A Scene Memory Framework for Interactive Long Video Generation](https://arxiv.org/abs/2605.16003)
...
### [83] [AgriMind: An Ensemble Deep Learning Framework for Multi-Class Plant Disease Classification](https://arxiv.org/abs/2605.16076)
...
### [87] [Second-Order Multi-Level Variance Correction for Modality Competition in Multimodal Models](https://arxiv.org/abs/2605.16165)
...
### [95] [Always Learning, Always Mixing: Efficient and Simple Data Mixing All The Time](https://arxiv.org/abs/2605.15220)
...
### [96] [DiscoExplorer: An Open Interface for the Study of Multilingual Discourse Relations](https://arxiv.org/abs/2605.15304)
*Amir Zeldes*
...
### [97] [Automatic Construction of a Legal Citation Graph from 100 Million Ukrainian Court Decisions: Large-Scale Extraction, Topological Analysis, and Ontology-Driven Clustering](https://arxiv.org/abs/2605.15362)
*Volodymyr Ovcharov*
...
### [98] [Greedy or not, here I come: Language production under vocabulary constraints in humans and resource-rational models](https://arxiv.org/abs/2605.15365)
...
### [99] [Adesua: Development and Feasibility Study of an AI WhatsApp Bot for Science Learning in West Africa](https://arxiv.org/abs/2605.15376)
...
### [100] [Eskwai for Students: Generative AI Assistant for Legal Education in Ghana](https://arxiv.org/abs/2605.15380)
...
### [101] [Capability Conditioned Scaffolding for Professional Human LLM Collaboration](https://arxiv.org/abs/2605.15404)
*Sen Yang,Yinglei Ma*
...
### [102] [Neural Activation Patterns Across Language Model Architectures: A Comprehensive Analysis of Cognitive Task Performance](https://arxiv.org/abs/2605.15436)
...
### [103] [Why are language models less surprised than humans? Testing the Parse Multiplicity Mismatch Hypothesis](https://arxiv.org/abs/2605.15440)
...
### [104] [Reasoning Models Don't Just Think Longer, They Move Differently](https://arxiv.org/abs/2605.15454)
...
### [105] [Retrieval-Augmented Large Language Models for Schema-Constrained Clinical Information Extraction](https://arxiv.org/abs/2605.15467)
...
### [106] [FINESSE-Bench: A Hierarchical Benchmark Suite for Financial Domain Knowledge and Technical Analysis in Large Language Models](https://arxiv.org/abs/2605.15482)
...
### [108] [DetectRL-X: Towards Reliable Multilingual and Real-World LLM-Generated Text Detection](https://arxiv.org/abs/2605.15518)
...
### [110] [When Latent Geometry Is Not Enough: Draft-Conditioned Latent Refinement for Non-Autoregressive Text Generation](https://arxiv.org/abs/2605.15557)
*De Shuai Zhang*
...
### [111] [GiLT: Augmenting Transformer Language Models with Dependency Graphs](https://arxiv.org/abs/2605.15562)
...
### [112] [Measuring Maximum Activations in Open Large Language Models](https://arxiv.org/abs/2605.15572)
...
### [113] [Response-Conditioned Parallel-to-Sequential Orchestration for Multi-Agent Systems](https://arxiv.org/abs/2605.15573)
...
### [114] [Calibrating LLMs with Semantic-level Reward](https://arxiv.org/abs/2605.15588)
...
### [121] [Few-Shot Large Language Models for Actionable Triage Categorization of Online Patient Inquiries](https://arxiv.org/abs/2605.15680)
*Liqi Zhou,Jiafu Li*
...
### [122] [ASRU: Activation Steering Meets Reinforcement Unlearning for Multimodal Large Language Models](https://arxiv.org/abs/2605.15687)
...
### [123] [H-Mem: A Novel Memory Mechanism for Evolving and Retrieving Agent Memory via a Hybrid Structure](https://arxiv.org/abs/2605.15701)
...
### [124] [SMMBench: A Benchmark for Source-Distributed Multimodal Agent Memory](https://arxiv.org/abs/2605.15710)
...
### [136] [CompactQE: Interpretable Translation Quality Estimation via Small Open-Weight LLMs](https://arxiv.org/abs/2605.15763)
...
### [141] [VCG-Bench: Towards A Unified Visual-Centric Benchmark for Structured Generation and Editing](https://arxiv.org/abs/2605.15677)
...
### [143] [SDOF: Taming the Alignment Tax in Multi-Agent Orchestration with State-Constrained Dispatch](https://arxiv.org/abs/2605.15204)
*Zhantao Wang*
...
### [144] [Does Theory of Mind Improvement Really Benefit Human-AI Interactions? Empirical Findings from Interactive Evaluations](https://arxiv.org/abs/2605.15205)
...
### [153] [SMCEvolve: Principled Scientific Discovery via Sequential Monte Carlo Evolution](https://arxiv.org/abs/2605.15308)
...
### [158] [Beyond Partner Diversity: An Influence-Based Team Steering Framework for Zero-Shot Human-Machine Teaming](https://arxiv.org/abs/2605.15400)
...
### [169] [PRISM: Prompt Reliability via Iterative Simulation and Monitoring for Enterprise Conversational AI](https://arxiv.org/abs/2605.15665)
